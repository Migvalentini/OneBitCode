...
//repo.owner.name = 'Miguel' Property 'name' does not exist on type 'Omit<GithubUserResponse, "name" | "company" | "blog" | "location" | "email" | "hireable" | "bio" | "twitter_username" | "public_repos" | "public_gists" | "followers" | "following" | "created_at" | "updated_at">'.
