...
function firstMenu() {
   const spaceshipName: string = prompt('Enter the spaceship name:')
   const pilot: string = prompt("Enter the pilot's name:")
   const crewLimit: number = Number(prompt('Enter the crew limit:'))
...
function addSpaceship(spaceshipName: string, pilot: string, crewLimit: number, crew?: string[], inMission?: boolean) {
   const spaceship = {
      spaceshipName,
      pilot,
      crewLimit,
   ...
   alert(
      `The spaceship ${spaceship.spaceshipName} was registered!\nData:
...
function addMemberToCrew(member: string, spaceship: { name: string , crewLimit: number, crew: string[]}) {
